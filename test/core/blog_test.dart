...
void main() => group('Blog', () {
  group('.fromJson()', () {
    ...
    test('should return an initialized instance with a non-empty map', () {
      ...
      expect(blog.url, equals(new Uri.https('dev.belin.io', '/akismet.dart')));
    });
  });

  group('.toJson()', () {
    test('should return only the blog URL with a newly created instance', () {
      var data = new Blog('https://dev.belin.io/akismet.dart').toJson();
    ...
    test('should return a non-empty map with an initialized instance', () {
      var data = new Blog('https://dev.belin.io/akismet.dart', charset: 'UTF-8', languages: ['en', 'fr']).toJson();
  ...
  group('.toString()', () {
    var data = new Blog('https://dev.belin.io/akismet.dart', charset: 'UTF-8', languages: ['en', 'fr']).toString();
