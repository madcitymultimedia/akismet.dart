...
describe('Client', function() {
  ...
  describe('#constructor()', () => {
    it('should initialize the existing properties', () => {
      ...
      assert.equal(client.blog.url, 'https://github.com/cedx/akismet.dart');
    });
  ...
  describe('#verifyKey()', () => {
    ...
    it('should return `false` for an invalid API key' , done => {
      var client = new Client({apiKey: '0123456789-ABCDEF', blog: _client.blog, test: _client.test});
